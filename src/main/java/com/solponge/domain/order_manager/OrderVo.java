...
public class OrderVo {
    ...
    public OrderVo(String payment_num, Long member_no, int product_num, int payment_stock, Date payment_date, String payment_phone, String payment_email, String payment_address, String delivery_info, Long delivery_num, int visible, int success) {
