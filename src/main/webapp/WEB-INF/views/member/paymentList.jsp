...
<div id="paymentlist">
    <div id="sidebar">
        <table>
            ...
            <tr>
                <td style="background-color: #007bff;"><a href="/com.solponge/member/${member.MEMBER_NO}/paymentList" style="color:white;">구매목록</a></td>
            </tr>
            <tr>
            ...
            <c:forEach items="${paginatedProducts}" var="i">
                ...
                <c:set var="paynum" value="${i.payment_num}"/>
                    <table class="tdbody">
                        ...
                        <tr>
                            <td rowspan="2"><img class="proimg" src="${productinfo.get(img)}"></td>
